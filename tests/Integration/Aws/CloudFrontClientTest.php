...
class CloudFrontClientTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->client = new CloudFrontClient(new CurlClient('test'), 'E2VS70WYKKG4W7', getenv('AWS_TEST_ACCESS_KEY_ID') ?: $_ENV['AWS_TEST_ACCESS_KEY_ID'], getenv('AWS_TEST_SECRET_ACCESS_KEY') ?: $_ENV['AWS_TEST_SECRET_ACCESS_KEY']);
    }

    public function testClearUrl(): void
    {
